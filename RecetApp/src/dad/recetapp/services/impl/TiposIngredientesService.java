...
public class TiposIngredientesService implements ITiposIngredientesService {
	...
	public void crearTipoIngrediente(TipoIngredienteItem tipo) throws ServiceException {
		try{
			if(tipo == null || tipo.getNombre() == null)
				throw new ServiceException("Error al crear el tipo de instruccion: El tipo no puede ser nulo.");
			...
			throw new ServiceException("Error al crear el tipo de instruccion '"+tipo.getNombre()+"': "+ e.getMessage());
	...
	public void modificarTipoIngrediente(TipoIngredienteItem tipo) throws ServiceException {
		try {
			...
			throw new ServiceException("Error al modificar el tipo de instruccion '"+tipo.getNombre()+"': "+ e.getMessage());
		} catch (NullPointerException e) {
			throw new ServiceException("Error al modificar el tipo de instruccion: El tipo no puede ser nulo.");
		}
	}
	...
	public void eliminarTipoIngrediente(Long id) throws ServiceException {
		try {
			...
			throw new ServiceException("Error al eliminar el tipo de instruccion '"+id+"': "+ e.getMessage());
		} catch (NullPointerException e){
			throw new ServiceException("Error al eliminar el tipo de instruccion: El tipo no puede ser nulo.");
		}
	}
	...
	public List<TipoIngredienteItem> listarTiposIngredientes() throws ServiceException {
		...
		try {
			...
			throw new ServiceException("Error al recuperar los tipos de instruccion", e);
		}
		return tipos;
	}
	...
	public TipoIngredienteItem obtenerTiposIngredientes(Long id) throws ServiceException {
		if(id == null)
			throw new ServiceException("Error al recuperar el tipo de instruccion: Debe especificar un id válido.");
		...
		try {
			...
			throw new ServiceException("Error al recuperar el tipo de instruccion con ID '"+id+"'", e);
		}
		return tipo;
	}
